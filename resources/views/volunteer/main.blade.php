...
@section('content')
                    ...
                    @foreach ($categories as $category)
                        <tr>
                            ...
                            <td style="text-align: center;">
                                ...
                                @else
                                    <button class="activity-button" id="activity-{{ $category->category_id }}"
                                        onclick="openActivityModal({{ $category->category_id }})"
                                        disabled>ทำกิจกรรม</button>
                                    <button class="edit-button" id="edit-{{ $category->category_id }}"
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @else
                                ...
                                <button class="view-button" onclick="openActivityDetailsModal(this)"
                                    disabled>ดูข้อมูลเพิ่มเติม</button>
                            @endif
                        </td>
                    </tr>
                @endforeach
    ...
    <div id="activityModal" class="modal">
        <div class="modal-content">
            ...
            <h2>บันทึกกิจกรรม</h2>
            <form id="activity-form" action="" method="POST" enctype="multipart/form-data" name="add-activity">
                @csrf
