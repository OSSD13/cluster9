                        ...
                        @foreach ($categories as $category)
                            <tr>
                                ...
                                <td style="text-align: center;" class="action-buttons">
                                    <button
                                        class="edit-button {{ $category->is_referenced == 0 ? 'disabled-button' : '' }}"
                                    ...
                                    <form action="{{ route('categories.destroy', $category->category_id) }}" method="POST"
                                        ...
                                        @method('DELETE')
                                        <button type="submit"
                                            class="btn btn-danger btn-sm {{ $category->is_referenced == 0 ? 'disabled-button' : '' }}"
                    ...
                    <form id="edit-form" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <select id="edit_category_mandatory" name="category_mandatory"
                                ...
                                <option value="0" {{ old('category_mandatory') == '0' ? 'selected' : '' }}>
                                    ไม่บังคับ
                                </option>
                            </select>
                    ...
                    <div class="modal-content">
                        ...
                        <form id="edit-form" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <select id="edit_category_mandatory" name="category_mandatory"
                                    class="form-control {{ $errors->updateCategory->has('category_mandatory') ? 'is-invalid' : '' }}">
                                    <option value="1" {{ old('category_mandatory') == '1' ? 'selected' : '' }}>
                                        บังคับ
                                    </option>
                                    <option value="0" {{ old('category_mandatory') == '0' ? 'selected' : '' }}>
                                        ไม่บังคับ
